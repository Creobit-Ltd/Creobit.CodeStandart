...
namespace CREO004_NewLineBeforeDirectives
{
    ...
    public class CREO004_NewLineBeforeDirectivesAnalyzer : DiagnosticAnalyzer
    {
        ...
        private static void AnalyzeNode(SyntaxNodeAnalysisContext context)
        {
            ...
            if (CheckIfHaveEmptyStringBefore(node) || CheckIfNodeFirstInBlock(node))
                return;
            ...
            context.ReportDiagnostic(Diagnostic.Create(Rule, diagnosticLocation, messageArg));
        }
